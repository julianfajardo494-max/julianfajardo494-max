...
Estratega de analítica avanzada, ingeniería de datos y operaciones con más de 15 años de trayectoria liderando la **transformación digital, la automatización inteligente y la toma de decisiones basada en datos** en sectores de **Manufactura B2B, BPO/Tecnología, Financiero y Salud**.
...
### 🤖 Machine Learning, Deep Learning & PLN (Core Científico)
...
<details open>
<summary><b>03️⃣ Semestre 3 — Especialización Sectorial & Proyecto Capstone</b></summary>

| Materia | Proyecto / Laboratorio Destacado | Enfoque Técnico & Algoritmos | Repositorio |
| :--- | :--- | :--- | :---: |
| **Analítica en Salud** | Modelos Predictivos y Análisis de Supervivencia | Regresión Logística, Cox Proportional Hazards | [Ver Repositorio](./) |
| **Trabajo Integrador II** | 🎓 **Proyecto Capstone: Sistema Predictivo de Planta** | End-to-End Machine Learning & MLOps | [Ver Repositorio](./) |
